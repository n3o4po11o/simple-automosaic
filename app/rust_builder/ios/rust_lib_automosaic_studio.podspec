...
A new Flutter FFI plugin project.
  ...
  s.script_phase = {
    ...
    :script => 'sh "$PODS_TARGET_SRCROOT/../cargokit/build_pod.sh" ../../rust rust_lib_automosaic_studio',
  ...
  s.pod_target_xcconfig = {
    ...
    'OTHER_LDFLAGS' => '-force_load ${BUILT_PRODUCTS_DIR}/librust_lib_automosaic_studio.a',
  }
end